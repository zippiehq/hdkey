...
Object.defineProperty(HDKey.prototype, 'privateKey', {
  ...
  set: function (value) {
    ...
    this._publicKey = Buffer.from(secp256k1.derivePublicKeyCompressed(value))
...
Object.defineProperty(HDKey.prototype, 'publicKey', {
  ...
  set: function (value) {
    ...
    this._publicKey = Buffer.from(secp256k1.compressPublicKey(value)) // force compressed point
    this._identifier = hash160(this.publicKey)
    this._fingerprint = this._identifier.slice(0, 4).readUInt32BE(0)
    this._privateKey = null
  }
...
HDKey.prototype.deriveChild = function (index) {
  ...
  if (this.privateKey) {
    ...
    try {
      hd.privateKey = Buffer.from(secp256k1.addTweakPrivateKey(this.privateKey, IL))
...
HDKey.prototype.sign = function (hash) {
  return Buffer.from(secp256k1.signMessageHashCompact(this.privateKey, hash))
}
